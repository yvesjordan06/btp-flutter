...
AnnonceModel _$AnnonceModelFromJson(Map<String, dynamic> json) {
  return AnnonceModel(
    ...
    idAnnonceurEntreprise: json['id_annonceur_entreprise'] as int,
    idAnnonceurParticulier: json['id_annonceur_particulier'] as int,
  );
}
...
Map<String, dynamic> _$AnnonceModelToJson(AnnonceModel instance) =>
    <String, dynamic>{
      ...
      'id_annonceur_entreprise': instance.idAnnonceurEntreprise,
      'id_annonceur_particulier': instance.idAnnonceurParticulier,
      'taches': instance.taches,
    };
...
NewMessageModel _$NewMessageModelFromJson(Map<String, dynamic> json) {
  return NewMessageModel(
    ...
    json['chatID'] == null
        ? _stringFromInt(json['chat_id'])
        : _stringFromInt(json['chatID']),
  );
}
